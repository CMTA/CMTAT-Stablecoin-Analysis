...
interface IAccessControl {
    ...
    /**
     * @dev Emitted when addresses are added to the redemption addresses
     */
    event RedemptionAddressesAdded(address[] addr);
    /**
     * @dev Emitted when addresses are removed from the redemption addresses
     */
    event RedemptionAddressesRemoved(address[] addr);
